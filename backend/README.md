...
## Project Structure
    ...
    ├── testapiautostoryboa_63021  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_63021`
...
2. Clone this repo and `cd testapiautostoryboa_63021`
